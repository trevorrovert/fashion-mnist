...
I execute my notebooks in a linux environment on AWS Sagemaker with the Data Science container image and Python 3 kernal module but these notebooks can easily be ported to use Google Colab as well.
